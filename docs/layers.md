...
hand-rolled fold are gone (breach §6 + Smartgun/IFF complete). **L7+** (the spreading
contagion families) is next.*
...
**Worm/logic-bomb** vector, the knockout-gate knob, and salvage-on-death) and the
**Smartgun/IFF** mod is in (`Attack.smart`). **Next (L7+):** the spreading **contagion**
families (Virus/Worm propagation via Data-spill).
