...
> are all in `crates/sim`. **Still 🔭:** mid-battle Resolve **recovery** (un-breaking a routed unit),
> a content **leader archetype** (the Anthem), and ⏳ tuning the Stress/Break/Rally feel-numbers.
