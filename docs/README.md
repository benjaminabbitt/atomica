...
5. **[netrunning.md](netrunning.md)** — the digital-attack system: the hack contest (`2d10 ≤ avg(Hacking, channel) − ICE`, channel = weaker endpoint's Link), the stat/skill line, payloads, the implant model, and the build order. Marks **built vs planned**.
